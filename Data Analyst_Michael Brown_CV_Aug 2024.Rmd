...
Experienced data professional seeking new Business Data Analytics challenges in the Biotechnology industry. <br>
...
* Data Extraction, Cleaning, Manipulation, & Analysis (SQL, Power BI, Excel, R)
* Data Model, ETL, Report, & Dashboard Development (Power BI/DAX, Tableau, SQL, R)
* Data Validation (SQL, Power BI, Excel)
* Project Management (Requirements management, Scheduling, & Forecasting)
* Effective Cross-Functional Communication, Interpersonal, & Presentation Skills
* Statistical Methodologies (Descriptive and Inferential Statistics, Logistic Regression using R)
* Ability to thrive in FDA/ISO regulated environments

### <u>Professional Experience</u>
<b>Data Analyst</b><br>
Baymar Solutions, Irvine, CA (Remote) •  <i>June 2021-May 2024</i><br>
...
### <u>Certifications</u>
* Microsoft Certified: Power BI Data Analyst Associate (Microsoft), Aug 2024
